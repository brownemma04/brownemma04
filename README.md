...
`Java` · `C++` · `C` · `Python` · `Rust` · `Erlang`
 
## 🎯 Currently Learning
 
- **Low-latency system design** — JVM tuning (GC internals, off-heap memory, allocation-free hot paths)
...
📫 Open to conversations on low-latency systems, trading infrastructure, crypto, and performance engineering.
